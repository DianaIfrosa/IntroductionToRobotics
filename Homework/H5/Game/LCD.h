...
const String informativeMessage = "Back:scroll left";
const String options[] = { "Start game", "Highscore", "Settings", "About", "How to play" };
const String instructions[] = { "Low difficulty:", "basic", "Medium diff:", "fixed obstacles", "High diff:", "obstacles and", "button press for", "passing walls.", informativeMessage, "" };
const String staticInfo = "Snake game";
...
const String highScoreCongrats[] = { "Congrats! You", "beat highscore!" };
...
void displayHighscoreCongrats() {
  lcd.setCursor(1, 0);
  lcd.print(highScoreCongrats[0]);

  lcd.setCursor(1, 1);
  lcd.print(highScoreCongrats[1]);
}
